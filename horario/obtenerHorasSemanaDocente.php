...
<script>
        ...
        */
                        ...
                        console.info(opciones_hora);
                         ...
                         if (!$(this).parent().hasClass('horaLibre')){ //Si no es hora libre = hora lectiva
                             ...
                             if (!$(this).parent().hasClass('ausencia')){ //Si no está marcado como ausencia
                                 ...
                                 $(icono_tarea).addClass("sin_tarea");
                                 console.info(idhora);
        ...
        function cambiarIconoNoHayObservaciones(imagen){
                console.info("Cambiamos icono no observacones");
        ...
        function guardar_observacion(docente,semana,dia,hora,observaciones){
                      ...
                      console.info("observaciones:"+observaciones);      
...
//NOs creamos un array para almacenar en cada fila una hora del horario. POr lo tanto tendremos un array de 5 filas cada una con 10 columnas. 
$datosHoras = array();
...
//NOs creamos un array para almacenar las ausencias.
        ...
        <div class="col-sm-2 bg-celda-info"> '.$vectorDias[1].' MARTES
         ...
         <div class="col-sm-2 bg-celda-info"> '.$vectorDias[2].' MIERCOLES
          ...
          <div class="col-sm-2 bg-celda-info"> '.$vectorDias[3].' JUEVES
           ...
           for($i=1;$i<7;$i++){ //RECORRERMOS LAS HORAS. HAY 7 HORAS PORQUE LA ÚLTIMA SUELE SER PARA REUNIONES
